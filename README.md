...
└── src/
    └── microservice-notifications/
        ...
        │   ├── v1/               # Versionado /v1/
        │   │   ├── __init__.py
        │   │   └── Notifications_blueprint.py  # Blueprint que contiene los endpoints de un recurso
        ...
        │   └── Notifications_repository.py # Operaciones DB para una coleccion (tabla) 
        │
        ├── models/               # 4. Modelos Pydantic
        │   ├── __init__.py
        │   ├── Notifications.py        # Modelos de datos (clases). Realizan validacion del tipo de dato (string, int,...)
        │
        ├── services/             # 5. Lógica de negocio
        │   ├── __init__.py
        │   └── Notifications_service.py # crear, debitar, actualizar, etc. Validacion avanzada
        │
