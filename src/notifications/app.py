...
from .api.v1.Notifications_blueprint import bp as notifications_bp_v1
...
def create_app():
    ...
    app = Quart("Notifications Service")
    ...
    # Load blueprints.
    app.register_blueprint(notifications_bp_v1)
...
#api = rutas, lo que ve el mundo
#service = la lógica
#db = base de datos
#models = formatos de los datos
#core = conexiones y configuración
#utils = cosas decorativas
#app.py = arranca todo